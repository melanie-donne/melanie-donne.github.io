class TypeWriter {
    ...
    type() {
        ...
        if(this.isDeleting){
            typingElement.className = "fas fa-cat-space erasing-animation";
        }else{
            typingElement.className = "fas fa-cat-space writing-animation";
        }
        ...
        if(!this.isDeleting && this.txt === fullTxt){
            ...
            typingElement.className = "fas fa-cat-space";
...
const words = ["UI/UX Designer", "Développeuse", "Cheffe de projet"];
